$(function () {
    ...
    var home = {
		...
		bind: function () {
            $('#container').on('click', '#showGzh', function () {
				console.log("dsdfs");				
                $('#dialog_gzh').show().on('click', '.weui_btn_dialog', function () {
                    $('#dialog_gzh').off('click').hide();
                });
            });
